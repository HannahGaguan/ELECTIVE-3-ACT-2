...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        <h1 class="text-2xl font-bold mb-4">RFID Data Display</h1>
        <div class="bg-white shadow-md rounded-lg p-6">
            <h2 class="text-xl font-semibold mb-2">Latest RFID Value:</h2>
            <div class="text-gray-700" id="latest-rfid">
                <?= htmlspecialchars($latest_rfid) ?: 'No RFID data available.' ?>
            </div>
            <h2 class="text-xl font-semibold mb-2 mt-4">Status:</h2>
            <div class="text-gray-700" id="status-message">
